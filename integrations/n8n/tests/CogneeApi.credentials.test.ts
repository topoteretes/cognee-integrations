...
describe('CogneeApi credential', () => {
	...
	describe('identity', () => {
		...
		it('exposes display metadata', () => {
			...
			expect(credential.icon).toEqual({ light: 'file:cognee.svg', dark: 'file:cognee.dark.svg' });
	...
	it('authenticates requests outside declarative routing, including dataset lookups', () => {
