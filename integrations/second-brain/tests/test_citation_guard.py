...
from cognee_integration_second_brain.cognee_adapter import _CitationRecord, select_citations
...
def test_note_not_in_evidence_is_not_cited():
    ...
    other_evidence = '- chunk 1 (data_id: 00000000-0000-0000-0000-000000000000): "unrelated"'
