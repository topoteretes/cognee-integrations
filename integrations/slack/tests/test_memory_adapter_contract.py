"""Unit tests for the thin chat-memory adapter interface.

Covers only the framework-agnostic contract: the channel→dataset mapping, the
value types, and abstractness of the interface. No cognee, no Slack, no keys.
"""

import asyncio

import pytest
from cognee_integration_slack.memory_adapter import (
    Answer,
    ChatMemory,
    Citation,
    ConversationRef,
...
def test_mapping_is_deterministic_and_hashable():
