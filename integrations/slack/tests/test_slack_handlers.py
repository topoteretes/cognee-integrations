...
import pytest
from cognee_integration_slack.memory_adapter import Answer
from cognee_integration_slack.slack_app import (
    handle_app_mention,
...
def test_answer_reply_is_rendered_via_render_answer(monkeypatch):
    ...
    import cognee_integration_slack.slack_app as slack_app
...
def test_non_slack_modules_import_without_slack_bolt():
    ...
    for mod in (
        "cognee_integration_slack.memory_adapter",
        "cognee_integration_slack.cognee_memory",
        "cognee_integration_slack.ingestion_buffer",
        "cognee_integration_slack.config",
        "cognee_integration_slack.citations",
        "cognee_integration_slack.slack_app",  # imports without slack_bolt (deferred)
        "cognee_integration_slack.__main__",  # entry point also imports without slack_bolt
    ):
...
def test_build_app_raises_clear_error_when_slack_bolt_missing():
    ...
    from cognee_integration_slack.config import SlackSettings
    from cognee_integration_slack.slack_app import build_app
