...
soon as the response completes — not one prompt later. Antigravity does not support
async command hooks yet (an ``async: true`` hook is skipped entirely), so this
runs synchronously with a tight timeout; Antigravity launches matching hooks
