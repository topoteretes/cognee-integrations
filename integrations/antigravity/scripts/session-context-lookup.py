...
Runs on the Antigravity PreInvocation hook. One ``/api/v1/recall`` request with
...
guidance block. That one string is injected as-is into Antigravity's context, so
