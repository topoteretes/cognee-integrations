#!/usr/bin/env python3
"""Run Cognee graph sync after the owning Antigravity process exits.

Antigravity may not invoke a plugin session-end event on normal shutdown.
SessionStart launches this watcher with the hook parent PID. The watcher
does nothing while Antigravity is alive; once that PID disappears, it starts the
