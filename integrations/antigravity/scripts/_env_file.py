...
# plugin var is the ONE line that differs between host integrations.
_PLUGIN_BACKEND_VAR = "COGNEE_ANTIGRAVITY_BACKEND"
_SHARED_BACKEND_VAR = "COGNEE_BACKEND"
_LOCAL_BACKEND_VALUES = ("local", "native", "sdk")
_CLOUD_BACKEND_VALUES = ("cloud", "http", "api", "server")

_TEMPLATE = """\
# Cognee plugin configuration — shared by existing Cognee plugins.
