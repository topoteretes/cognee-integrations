"""cognee-plugin - offline usage-metrics CLI for the Cognee Antigravity plugin.
...
network, no import of the cognee package:
    ~/.cognee-plugin/antigravity/hook.log
    ~/.cognee-plugin/antigravity/save_counter.json
    ~/.cognee-plugin/antigravity/last_recall.json
    ~/.cognee-plugin/antigravity/recall-audit.log
"""
...
# Each host integration reads its own state directory.
