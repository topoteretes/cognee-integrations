---
name: codebase
description: Use when ingesting, cognifying, or querying a codebase with Cognee CLI from Antigravity.
---

# Cognee CLI Codebase Workflows

Use this skill when the user asks Antigravity to build a Cognee memory of a repository,
