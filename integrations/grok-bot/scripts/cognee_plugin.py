"""cognee-plugin - offline usage-metrics CLI for the cognee Grok Bot plugin.
...
network, no import of the cognee package:
    ~/.cognee-plugin/grok-bot/hook.log
    ~/.cognee-plugin/grok-bot/save_counter.json
    ~/.cognee-plugin/grok-bot/last_recall.json
    ~/.cognee-plugin/grok-bot/recall-audit.log
"""
