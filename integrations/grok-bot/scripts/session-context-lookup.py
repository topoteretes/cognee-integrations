...
def _count_cross_session_hits(by_source: dict, session_id: str) -> int:
    ...
    the model could not have known from this conversation alone.
    """
    count = 0
...
async def _run(prompt: str, cwd: str = "") -> dict | None:
    ...
    try:
        ...
        _state = _Path.home() / ".cognee-plugin" / "grok-bot" / "last_recall.json"
    ...
    try:
        ...
        _audit = _Path.home() / ".cognee-plugin" / "grok-bot" / "recall-audit.log"
