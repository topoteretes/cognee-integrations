"""Catalog of indexed files, plus Spotlight-style filename matching.
...
even before cognify has finished (exactly like Spotlight showing name hits
first).
...
class Catalog:
    ...
    def match_names(self, query: str, limit: int = 10) -> list[dict[str, Any]]:
        """Rank catalog entries against ``query`` the way Spotlight ranks names:
